<!-- Add Modal -->
<div wire:ignore.self id="editExpenseModal" class="modal fade" tabindex="-1" role="dialog"
	aria-labelledby="editExpenseModal" aria-hidden="true" style="display: none;">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-footer">
				...
				<button type="submit" class="btn btn-info waves-effect waves-light" wire:click='updateExpenseCategory'>
					Save changes
				</button>
			</div>
		</div>
