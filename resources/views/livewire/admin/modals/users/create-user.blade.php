<!-- Add Modal -->
<div wire:ignore.self id="addStaffModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="addStaffModal"
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-footer">
				...
				<button type="submit" class="btn btn-info waves-effect waves-light" wire:click='storeStaff'>
					Save changes
				</button>
			</div>
		</div>
