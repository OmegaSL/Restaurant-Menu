...
<div class="nav-header">
	<a href="{{ url('/') }}" class="brand-logo" target="_blank">
		<img class="logo-abbr"
			src="{{ $setting->site_favicon != null ? asset('storage/' . $setting->site_favicon) : asset('assets/images/logo1.png') }}"
			alt="">
		<img class="logo-compact"
			src="{{ $setting->site_logo != null ? asset('storage/' . $setting->site_logo) : asset('assets/images/logo-text.jpg') }}"
			alt="">
				...
				<ul class="navbar-nav header-right">
					<li class="nav-item dropdown notification_dropdown">
						<a class="nav-link dz-fullscreen primary" href="#">
							<svg id="Capa_1" enable-background="new 0 0 482.239 482.239" height="22" viewBox="0 0 482.239 482.239"
					...
					<li class="nav-item dropdown header-profile">
						<a class="nav-link" href="#" role="button" data-toggle="dropdown">
							...
							<img src="{{ auth()->user()->gravatar }}" width="20" alt="" />
						</a>
						<div class="dropdown-menu dropdown-menu-right">
